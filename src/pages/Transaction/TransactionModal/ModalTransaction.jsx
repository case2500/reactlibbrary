      ...
      <div className="modal w-[600px] text-md">
        <div className=" ">
          <div className="container mx-auto text-gray-600">
            ชื่อ : {showtransaction.username} - createdAt=
            {showtransaction.createdAt}  
            {/* {JSON.stringify(showtransaction.slice(8, 10))} */}
             {/* {showtransaction.updatedAt.slice(8, 10) +
                  "-" +
                  showtransaction.updatedAt.slice(5, 7) +
                  "-" +
                  (Number(showtransaction.updatedAt.slice(0, 4)) + 543)}
            updatedAt={showtransaction.updatedAt} */}
          </div>
          <hr />
