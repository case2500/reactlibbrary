...
import Autocomplete from "./../borrow/Autocomplete.jsx";
const Startborrower = () => {
  ...
  return (
    <div>
      ...
      <div className="flex flex-row justify-center my-2 ">
        <div className="flex flex-row justify-center mx-1  w-full -mt-1 ">
          <input
            ...
            className=" max-w-96   border border-gray-200 mt-1 px-1 text-md rounded-md"
          />
        </div>
      ...
      <div className="grid grid-cols-8 gap-x-1 mx-5 ">
